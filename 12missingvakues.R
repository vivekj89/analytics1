...
complete.cases(sleep) # of which row have complete data in T/F
...
sleep[!complete.cases(sleep),] #rows wich have missing values
colSums(is.na(sleep)) # which coloumn has how many data missing
